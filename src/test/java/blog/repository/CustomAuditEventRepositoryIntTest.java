...
import blog.config.audit.AuditEventConverter;
import blog.domain.PersistentAuditEvent;
...
import static blog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
